...
![Daily entries grouped by meal with food details](../images/log-01-daily-entries.png)

### Daily Macro Bars

Bars at the top showing your running total of calories, protein, fat, and carbs against your daily targets.

![Daily macro bars showing totals versus targets](../images/log-02-macro-bars.png)

### Date Navigation

The current date is displayed at the top. Swipe left and right or tap the date controls to move between days.

![Date navigation controls at top of Log screen](../images/log-03-date-navigation.png)
...
!!! tip "Multi-select for meal planning"
    ...
    ![Multi-select mode with selected items and action buttons](../images/log-04-multi-select.png)
