...
![Text search results with gray, blue, and red color coding](../images/search-01-color-coded.png)

**Globe icon** — Tap to extend your search to Open Food Facts, a database of millions of packaged products worldwide.

![Globe icon to access Open Food Facts search](../images/search-02-globe-icon.png)

### Barcode Search

Switch to this tab to scan a barcode. The app checks your local foods first, then Open Food Facts.

![Barcode tab with camera scanner view](../images/search-03-barcode.png)
...
![Search result showing plus button and serving size dropdown](../images/search-05-result-actions.png)
...
!!! tip "The Log Queue preview"
    ...
    ![Log Queue preview bar with food images and down arrow](../images/search-06-queue-preview.png)
