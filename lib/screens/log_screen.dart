...
class FoodLogEntry {
  ...
  const FoodLogEntry({required this.timestamp, required this.foods});
}
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Text(food.emoji, style: const TextStyle(fontSize: 18)),
                ),
              ),
...
class DraggableFoodItemWidget extends StatefulWidget {
  ...
  @override
  State<DraggableFoodItemWidget> createState() =>
      _DraggableFoodItemWidgetState();
}
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: const Center(
                  child: Icon(Icons.edit, color: Colors.blue, size: 32),
                ),
              ),
            ),
          ),
            ...
            child: GestureDetector(
              ...
              onTap: _showActions
                  ...
                  : (widget.isInSelectionMode
                        ? widget.onTap
                        : null), // Tap works in selection mode or to close actions
...
class FoodLogEntryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalCalories = entry.foods.fold(
      0.0,
      (sum, food) => sum + food.calories,
    );
    final totalProtein = entry.foods.fold(
      0.0,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    _buildTotalChip(
                      'P ${totalProtein.toStringAsFixed(1)}',
                      Colors.red,
                    ),
                    const SizedBox(width: 4),
                    _buildTotalChip(
                      'F ${totalFat.toStringAsFixed(1)}',
                      Colors.yellow,
                    ),
                    const SizedBox(width: 4),
                    _buildTotalChip(
                      'C ${totalCarbs.toStringAsFixed(1)}',
                      Colors.green,
                    ),
                    const SizedBox(width: 4),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_foodLogEntries.isEmpty)
                      ...
                      ..._foodLogEntries.map(
                        (entry) => FoodLogEntryWidget(
                          entry: entry,
                          onEditFood: _editFood,
                          onDeleteFood: _deleteFood,
                          onTapFood:
                              _toggleItemSelection, // Regular tap works in selection mode
                          onLongPressFood:
                              _startSelectionMode, // Long press starts selection mode
