...
class MockSearchProvider extends _i1.Mock implements _i23.SearchProvider {
  ...
  @override
  _i13.Future<void> loadSuggestions() =>
      (super.noSuchMethod(
...
class MockDatabaseService extends _i1.Mock implements _i6.DatabaseService {
  ...
  @override
  _i13.Future<List<({int foodId, int logTimestamp})>> getSoloFoodLogs({
    int? lookbackDays = 30,
  }) =>
      (super.noSuchMethod(
            ...
            returnValue:
                _i13.Future<List<({int foodId, int logTimestamp})>>.value(
                  <({int foodId, int logTimestamp})>[],
                ),
          )
          as _i13.Future<List<({int foodId, int logTimestamp})>>);
